...
return [
    ...
    'views' => [
        [
            'region'   => 'header', 
            'template' => 'buggers/header', 
            'data'     => [
                'siteTitle' => "Buggers",
                'siteTagline' => "Tell your friends how much you hate them",
            ], 
            'sort'     => -1
        ],
        ['region' => 'footer', 'template' => 'buggers/footer', 'data' => [], 'sort' => -1],
        [
            'region' => 'navbar',
            'template' => [
                'callback' => function() {
    ...
    'data' => [
        ...
        'title_append' => ' | Buggers at your service!',

        // Stylesheets
        'stylesheets' => ['css/buggers/stylephp/style.php'],
